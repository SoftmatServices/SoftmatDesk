											...
											return"function"===n.type(a)
												...
												return null!=a&&a===a.window},isNumeric:function(a){
													...
													return!n.isArray(a)&&b-parseFloat(b)+1>=0
														...
														for(b in a);return void 0===b||k.call(a,b)},isEmptyObject:function(a){
															var b;
															for(b in a)return!1;return!0},type:function(a){
																return null==a?a+"":"object"==typeof a||"function"==typeof a?i[j.call(a)]||"object":typeof a
															},globalEval:function(a){
																	var b,c=eval;a=n.trim(a),a&&(1===a.indexOf("use strict")?(b=d.createElement("script"),
																		b.text=a,d.head.appendChild(b).parentNode.removeChild(b)):c(a))},camelCase:function(a){
																		return a.replace(p,"ms-").replace(q,r)},nodeName:function(a,b){
																			return a.nodeName&&a.nodeName.toLowerCase()===b.toLowerCase()
																		},each:function(a,b){
																				var c,d=0;if(s(a)){
																					for(c=a.length;c>d;d++)if(b.call(a[d],d,a[d])===!1)
																						break
																				...
																				for(var d,e=[],f=0,g=a.length,h=!c;g>f;f++)d=!b(a[f],f),d!==h&&e.push(a[f]);
																					...
																					"Boolean Number String Function Array Date RegExp Object Error Symbol".split(" "),function(a,b){i["[object "+b+"]"]=b.toLowerCase()
																				});function s(a){
																				...
																				},X=/^(?:input|select|textarea|button)$/i,Y=/^h\d$/i,Z=/^[^{]+\{\s*\[native \w/,$=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,
																					_=/[+~]/,aa=/'|\\/g,
																					...
																					ca=function(a,b,c){
																						...
																						m()};try{
																							...
																							E[v.childNodes.length].nodeType}catch(ea){
																								H={
																								...
																								var f,h,j,k,l,o,r,s,w=b&&b.ownerDocument,x=b?b.nodeType:9;if(d=d||[],
																								...
																								if(!e&&((b?b.ownerDocument||b:v)!==n&&m(b),b=b||n,p)){
																									...
																									if((f=o[3])&&c.getElementsByClassName&&b.getElementsByClassName)
																										...
																										(k=b.getAttribute("id"))?k=k.replace(aa,"\\$&"):b.setAttribute("id",
																											k=u),
																										r=g(a),
																										h=r.length,l=V.test(k)?"#"+k:"[id='"+k+"']";
																										while(h--)r[h]=l+" "+qa(r[h]);
																										s=r.join(","),
																										w=_.test(a)&&oa(b.parentNode)||b}if(s)try{
																								...
																								return i(a.replace(Q,"$1"),b,d,e)}function ga(){
